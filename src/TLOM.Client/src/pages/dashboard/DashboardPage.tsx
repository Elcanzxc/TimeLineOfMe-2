    ...
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent>
            <div className="flex flex-col gap-4">
              <p className="text-sm text-muted-foreground italic">No recent activity yet. Start adding items to your timeline!</p>
            </div>
          </CardContent>
        </Card>
        <Card className="col-span-3">
          ...
          <CardContent>
            <div className="flex flex-col gap-4">
              <p className="text-sm text-muted-foreground italic">Follow users to see their activity here.</p>
            </div>
          </CardContent>
        </Card>
      </div>
